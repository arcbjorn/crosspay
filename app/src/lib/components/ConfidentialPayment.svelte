...
<div class="payment-form">
	...
	<div class="form-group">
		...
		<input id="amount" type="number" bind:value={amount} placeholder="1.0" step="0.001" min="0" />
	...
	<div class="form-group">
		...
		<input id="metadata" type="text" bind:value={metadataURI} placeholder="ipfs://..." />
	</div>

	<div class="privacy-toggle">
		<input id="privacy-mode" type="checkbox" bind:checked={privateMode} />
		<label for="privacy-mode">
			🔒 Private Payment
			{#if privateMode}
				<span class="privacy-info"> Amount will be encrypted and hidden from public view </span>
			{/if}
		</label>
	</div>
