...
<!-- Toast container -->
<div
	class="pointer-events-none fixed z-50 flex flex-col gap-2 {positionClasses[position]}"
...
<audio id="toast-sound" preload="none">
	<source
		src="data:audio/wav;base64,UklGRuACAABXQVZFZm10IBAAAAABAAEAIlYAAESsAAACABAAZGF0YeACAAABAAAA"
		type="audio/wav"
	/>
</audio>
