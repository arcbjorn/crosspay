...
<div class="space-y-6">
	...
	<div class="card bg-base-100 shadow-xl">
		<div class="card-body">
			...
			{:else if healthStatus}
				<div class="grid grid-cols-2 gap-4 md:grid-cols-4">
					...
					<div class="stat">
						...
						<div
							class="stat-value text-sm {healthStatus.ftsoHealthy ? 'text-success' : 'text-error'}"
						>
					...
					<div class="stat">
						...
						<div
							class="stat-value text-sm {healthStatus.randomHealthy
								? 'text-success'
								: 'text-error'}"
						>
					...
					<div class="stat">
						...
						<div
							class="stat-value text-sm {healthStatus.fdcHealthy ? 'text-success' : 'text-error'}"
						>
			...
			{:else}
				<div class="text-error">Failed to load oracle health status</div>
			{/if}
		</div>
	</div>
	...
	<div class="card bg-base-100 shadow-xl">
		<div class="card-body">
			<div class="mb-4 flex items-center justify-between">
				...
				<button class="btn btn-primary" on:click={requestRandomNumber} disabled={loadingRandom}>
	...
	<div class="card bg-base-100 shadow-xl">
		<div class="card-body">
			...
			<div class="alert alert-info mb-4">
				...
				<span
					>FDC (Flare Data Connector) allows verification of external blockchain data through Merkle
					proofs.</span
				>
			</div>
			...
			<div class="grid gap-6 md:grid-cols-2">
				<!-- Submit Proof Form -->
				<div>
					<h3 class="mb-3 text-lg font-semibold">Submit New Proof</h3>
				...
				<!-- Verify Proof Form -->
				<div>
					<h3 class="mb-3 text-lg font-semibold">Verify Existing Proof</h3>
			...
			{#if proofResults.length > 0}
				...
				<h3 class="mb-3 text-lg font-semibold">Verification Results</h3>
				<div class="overflow-x-auto">
					<table class="table-zebra table">
						<thead>
							<tr>
