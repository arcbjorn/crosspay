...
<div class="flex items-center">
	{#if wallet.isConnected}
		<div class="dropdown dropdown-end">
			...
			<ul role="menu" class="dropdown-content menu bg-base-100 rounded-box w-80 p-2 shadow">
				...
				{#if needsChainSwitch}
					<li>
						<button class="btn btn-warning btn-sm" on:click={handleSwitchChain}>
				...
				<li>
					<button class="btn btn-outline btn-sm" on:click={handleDisconnect}> Disconnect </button>
				</li>
			</ul>
		</div>
	{:else}
		<div class="dropdown dropdown-end">
			...
			{#if showWalletOptions}
				<ul role="menu" class="dropdown-content menu bg-base-100 rounded-box w-60 p-2 shadow">
