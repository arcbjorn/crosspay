...
describe('StorageService', () => {
	...
	describe('downloadFile', () => {
		...
		it('should handle download errors', async () => {
			...
			await expect(storageService.downloadFile('invalid-cid')).rejects.toThrow(
				'File not found: invalid-cid'
			);
		});
	});
	...
	describe('verifyFile', () => {
		...
		it('should handle verification errors', async () => {
			...
			await expect(storageService.verifyFile('invalid-cid')).rejects.toThrow(
