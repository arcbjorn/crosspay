...
<div class="mx-auto max-w-6xl">
	...
	<div class="mb-8 flex items-center justify-between">
		...
		<a href="/pay" class="btn btn-primary"> New Payment </a>
	</div>
	...
	{:else if payments.length === 0}
		<div class="py-16 text-center">
			...
			<h3 class="mb-2 text-2xl font-bold">No payments yet</h3>
			<p class="text-base-content/70 mb-6">
				Your payment history will appear here once you send your first payment.
			</p>
					...
					<div class="card-body">
						<div class="flex items-start justify-between">
							...
							<div class="ml-4 flex flex-col gap-2">
								...
								<a href="/receipt/{payment.id}" class="btn btn-outline btn-sm"> View Receipt </a>
							</div>
						</div>
					</div>
				</div>
