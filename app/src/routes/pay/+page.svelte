	...
	const handleSubmit = async () => {
		...
		try {
			...
			if (!isNative && wallet.address && paymentService && erc20Service) {
				...
				const parsedAmount = erc20Service.parseTokenAmount(
					amount,
...
<div class="mx-auto max-w-2xl">
	...
	<div class="card bg-base-100 shadow-xl">
		<div class="card-body">
			<h2 class="card-title mb-6 text-3xl">Send Payment</h2>
			...
			{:else}
				<form on:submit|preventDefault={handleSubmit} class="space-y-6">
					...
					<!-- Token Selection -->
					<TokenSelector bind:selectedToken chainId={selectedChain} disabled={isSubmitting} />
					...
					<div class="card bg-base-200/50 border-none">
						<div class="card-body p-4">
							<h3 class="mb-2 text-sm font-medium">Current Exchange Rates</h3>
